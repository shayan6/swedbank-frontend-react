...
const Home = () => {
  ...
  const getCSVContent = () => {
    ...
    accountData.forEach((account) => {
      ...
      csv += `${account.account},${account.balance.toFixed(
        2
      )},${account.credit.toFixed(2)},${account.reserved.toFixed(
        2
      )},${available}\n`;
    });
    csv += `Total,${totalBalance.toFixed(2)},${totalCredit.toFixed(
      2
    )},${totalReserved.toFixed(2)},${(totalBalance - totalReserved).toFixed(
      2
    )}\n`;
    return csv;
  };
